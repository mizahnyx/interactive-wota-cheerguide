...
/* method: GetTestString of class  BrowserQueue */
#ifndef TOLUA_DISABLE_tolua_BrowserQueue_BrowserQueue_GetTestString00
static int tolua_BrowserQueue_BrowserQueue_GetTestString00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  BrowserQueue* self = (BrowserQueue*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetTestString'", NULL);
#endif
 {
  std::string tolua_ret = (std::string)  self->GetTestString();
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetTestString'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_BrowserQueue_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,"BrowserQueue");
  ...
  tolua_function(tolua_S,"GetTestString",tolua_BrowserQueue_BrowserQueue_GetTestString00);
